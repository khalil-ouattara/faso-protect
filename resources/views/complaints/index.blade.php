...
@section('content')
                    ...
                    <table class="w-full whitespace-no-wrap">
                        <thead>
                            <tr
                                ...
                                <th class="px-4 py-3">Plaignant</th>
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            @foreach ($complaints as $complaint)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3">{{ $complaint->complainant }}</td>
                                    <td class="px-4 py-3">{{ $complaint->subject }}</td>
                                    <td class="px-4 py-3">{{ $complaint->description }}</td>
                                    <td class="px-4 py-3">{{ $complaint->status->name }}</td>
                                    <td class="px-4 py-3">
                                        ...
                                        <form style="display: inline-block"
                                            action="{{ route('complaints.destroy', $complaint) }}" method="POST"
                                            onsubmit="return confirm('Êtes-vous sûr ?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                class="px-2 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">Supprimer</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        <div class="w-full overflow-x-auto">
            <div class="flex items-center justify-center p-4 mb-8 text-sm font-semibold rounded-lg">
                <div>
                            ...
                            <form action="{{ route('complaints.store') }}" method="POST"
                                ...
                                <label class="block text-sm">
                                    ...
                                    <input
                                        ...
                                        name="complainant" type="text" required placeholder="Jane Doe" />
                                </label>
                                <label class="block text-sm">
